...
defineProps({
  ...
  description: {
    type: String,
    default:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi mi est, mattis et ultricies vel, accumsan quis velit.',
  },
  price: {
    type: Number,
    default: 7.99,
  ...
  >
    ...
    <div class="p-4">
      <div class="mb-2 flex items-center justify-between">
        <p class="text-slate-800 text-xl font-semibold">{{ title }}</p>
        <p class="text-cyan-600 text-xl font-semibold">${{ price }}</p>
      </div>
